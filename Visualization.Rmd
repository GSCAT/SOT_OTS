...
for (brand in unique(SOT_viz_by_brand$ReportingBrand)) {
  p1 <- ggplot(subset(SOT_viz_by_brand,ReportingBrand == brand), aes(ShipCancelWeek, Units)) + 
  ...
  p2 <- ggplot(subset(SOT_viz_by_brand,ReportingBrand == "BR INTL"), aes(ShipCancelWeek, SOT, label = SOT)) +
