...
drv <- JDBC("com.teradata.jdbc.TeraDriver", 
            paste(paste("/mnt", "Ke2l8b1", "Resources", "drivers", "teradata", "terajdbc4.jar:",  
                        sep = .Platform$file.sep), 
                  paste("/mnt", "Ke2l8b1", "Resources", "drivers", "teradata", "tdgssconfig.jar",  
                        sep = .Platform$file.sep), 
                  sep = ""))
...
#            "/mnt/Ke2l8b1/Resources/drivers/teradata/terajdbc4.jar:/mnt/Ke2l8b1/Resources/drivers/teradata/tdgssconfig.jar")
 ...
 my_connect = dbConnect(drv,
                      paste("jdbc:teradata://TDPRODCOP1.GID.GAP.COM/LOGMECH=LDAP,charset=UTF8,USER=",Sys.getenv("USERNAME"),",", "PASSWORD=",Sys.getenv("PASSWORD"), sep = "")
 )
