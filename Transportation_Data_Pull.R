...
Transportation_Month_IB <- sqlQuery( channel , "select [Purchase Order Number], [PO Type], [Container Number1], [BL/AWB#1], [Vessel], [InDC Calc Method], [INDC], [INDC+2], [Total Shipped Qty] from IB_Summary;")
close(channel)
